"""
This script read the data generated by the scripts 'Demo_test_automap_random_noise.py'
and 'Demo_test_lasso_random_noise.py', and compute the error maps for the 
reconstructed images produced by these scripts.
"""
